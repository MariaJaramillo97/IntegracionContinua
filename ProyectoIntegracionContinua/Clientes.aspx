<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Clientes.aspx.cs" Inherits="ProyectoIntegracionContinua.Clientes" %>
                ...
                <form id="form1" runat="server">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                              <asp:TextBox ID="nombres" runat="server" type="text" placeholder="Nombres" class="form-control"></asp:TextBox> 
                            </div>
                        </div>
                        <div class="form-group">
                            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span>
                            <div class="col-md-8">
                               <asp:TextBox ID="apellidos" runat="server" type="text" placeholder="Apellidos" class="form-control"></asp:TextBox> 
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                              <asp:TextBox ID="cedula" runat="server" type="text" placeholder="Cedula" class="form-control"></asp:TextBox> 
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <asp:TextBox ID="correo" runat="server" type="text" placeholder="Correo" class="form-control"></asp:TextBox> 
